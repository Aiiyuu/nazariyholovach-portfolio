...
import { SlideIn, StaggeredWords } from "@/shared/components/animations";
import { Button } from "@/shared/components/ui";
import clsx from "clsx";
import { useTranslation } from "react-i18next";
import { Project } from "@/features/work";

type Props = { project: Project; zIndex: number };

export const ProjectCard: React.FC<Props> = ({ project, zIndex }) => {
