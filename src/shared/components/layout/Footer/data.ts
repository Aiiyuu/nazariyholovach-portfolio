...
export const footerLists: FooterItem[][] = [
  [
    { id: "footer.mainWorks", title: true },
    {
      id: "footer.theMet",
    ...
    { id: "footer.game2048", demo: "https: //aiiyuu.github.io/js_2048_game/" },
  ],
  [
    { id: "footer.otherPages", title: true },
    { id: "footer.home", page: "home" },
    { id: "footer.aboutMe", page: "about" },
    { id: "footer.works", page: "work" },
  ],
  [
    { id: "footer.navigation", title: true },
    { id: "footer.introduction", navigate: "#introduction" },
    { id: "footer.mainProjects", navigate: "#main-projects" },
    { id: "footer.skills", navigate: "#skills" },
  ],
];

export const socialNetworks: SocialNetwork[] = [
  { icon: Github, link: "https: //github.com/Aiiyuu?tab=repositories" },
  {
    icon: LinkedIn,
    link: "https: //www.linkedin.com/in/nazariy-holovach-a6a30738a/",
  },
  { icon: Telegram, link: "https: //t.me/nazariyholovach" },
  {
    icon: Spotify,
